...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all duration-[var(--motion-normal)] ease-[var(--ease-out)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] motion-safe:active:scale-[0.98]',
  {
    variants: {
      variant: {
        ...
        'pill-outline': 'rounded-full border border-border bg-card text-foreground hover:bg-muted',
      },
      size: {
