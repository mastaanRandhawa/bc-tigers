      ...
      output: {
        manualChunks(id) {
          if (!id.includes('node_modules')) {
            ...
            if (id.includes('/src/pages/coach/') || id.includes('/src/pages/referee/') || id.includes('/src/pages/player/')) {
          ...
          if (id.includes('lucide-react') || id.includes('@radix-ui') || id.includes('react-hook-form') || id.includes('zod')) {
            return 'vendor-ui';
          }
        },
      },
